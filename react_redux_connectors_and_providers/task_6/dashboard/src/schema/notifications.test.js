...
describe('getAllNotificationsByUser', () => {
  it('should return the correct notifications for userId 5debd764a7c57c7839d722e9', () => {
    ...
    // Call the function with the normalized data
    const result = getAllNotificationsByUser('5debd764a7c57c7839d722e9', normalizedData);

    // Verify that the function returns the expected notifications
